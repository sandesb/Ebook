...
<body>
    ...
    <div id="templatemo_container">
        <div id="templatemo_menu">
            <ul>
                ...
                <li><a class="current">Self Help</a></li>
   ...
   //here sonoo is database name, root is username and password  
                        ...
                        ResultSet rs = stmt.executeQuery("select * from horror");
                    ...
                    <div class="templatemo_product_box">
                        ...
                        <div class="product_info">
                            <p> <%=rs.getString(8)%> </p>
                            <br>
                                 <div class="buy_now_button"><a href="http://localhost:8081/Ebook1/The Mountain Is You by Brianna Wiest (z-lib.org).pdf">Read Now</a></div>
